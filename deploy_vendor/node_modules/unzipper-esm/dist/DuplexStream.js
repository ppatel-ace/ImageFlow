...
function _setPrototypeOf(t, e) { return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, _setPrototypeOf(t, e); } // Copy-pasted from `duplexer3` source code on Jun 19th, 2026:
...
//
// 'node:stream'
var DuplexStream = exports["default"] = /*#__PURE__*/function (_Duplex) {
  /**
   ...
   */
  function DuplexStream(writable, readable, options) {
    var _this;
    _classCallCheck(this, DuplexStream);
    _this = _callSuper(this, DuplexStream, [options]);
  ...
  _inherits(DuplexStream, _Duplex);
  return _createClass(DuplexStream, [{
    key: "_write",
    value: function _write(input, encoding, done) {
