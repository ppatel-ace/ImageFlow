...
var _parseXmlStream = _interopRequireDefault(require("../xml/parseXmlStream.js"));
...
function readXlsxFile(file, options) {
  return (0, _unpackXlsxFileBrowser["default"])(file).then(function (contents) {
    return (0, _parseSpreadsheetContents["default"])(createWorkerFunction, _parseXmlStream["default"], contents, options);
  });
}
