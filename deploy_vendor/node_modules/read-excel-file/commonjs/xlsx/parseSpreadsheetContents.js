 ...
 * @return {Promise<Sheet[]>}
 */
function parseSpreadsheetContentsInWorker(createWorkerFunction, parseXmlStream, contents, options) {
  ...
  if (!(options && options.parseNumber)) {
    options = _objectSpread(_objectSpread({}, options), {}, {
      parseNumber: _parseNumber["default"]
    });
  }
  ...
  function () {
    return [parseXmlStream, parseNumber, parseSpreadsheetContents, getSheetRelationId, getSheetNameByRelationId, getXmlFilesAtFixedPaths, getXmlFilesAtNonFixedPaths, getSheetDataXmlFiles, readFiles, _checkpoint["default"], _checkpoint.latestCheckpointTimestamp, _isPromise["default"]
    // parseSheet,
    //
  ...
  return Object.keys(filePaths.sheets).filter(function (sheetRelationId) {
    ...
    return _objectSpread(_objectSpread({}, filesInfo), {}, _defineProperty({}, filePaths.sheets[sheetRelationId], {
      ...
      parse: function parse(content, parseXmlStream) {
        return (0, _parseSheet["default"])(content, parseXmlStream, sheetDataParserParameters);
      }
    }));
  }, {});
}
